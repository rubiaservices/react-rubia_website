...
const DriverServiceTableCard = (props) => {
    ...
    const td1 ={
        padding:"35px", border:"1px solid white", font:"30px",background: "#C68643", color:"#144273" 
    }
    const td2 ={
        padding:"20px", border:"1px solid white", font:"40px", background: "#144273", color:"#FFFF"
    }
  ...
  return (
    <>
        <table style={{margin: " 15px 0px"}} className='fw-bold w-100 h-auto'>
            <thead>
                <tr>
